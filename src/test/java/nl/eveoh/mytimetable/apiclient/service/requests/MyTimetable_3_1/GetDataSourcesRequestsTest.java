...
public class GetDataSourcesRequestsTest extends HttpResponseMockTestBase {
    ...
    private static final String EMPTY_GET_DATABASES_RESPONSE = "{\"databases\":[]}";

    private static final String EXPECTED_PATH = API_PATH + "v0/databasedetails";


    @Test
    public void get() throws IOException {
        CloseableHttpResponse httpResponse = createResponse(HttpStatus.SC_OK, EMPTY_GET_DATABASES_RESPONSE);
