...
public class EventListStreamMapperTest extends BaseStreamMapperTest<EventListStreamMapper> {
    ...
    public void testMapper() throws Exception {
        ...
        Assert.assertEquals("Complex Functions", events.get(0).getActivityDescription());
        Assert.assertNull(events.get(0).getModuleCode());
        ...
        Assert.assertEquals("Department of Science", events.get(0).getDepartment().getName());
        ...
        Assert.assertEquals("Mr. Harris (Har)", events.get(0).getStaffMembers().get(0).getName());
        Assert.assertEquals("WAL", events.get(0).getStaffMembers().get(1).getKey());
        Assert.assertEquals("Ms. Walker (Wal)", events.get(0).getStaffMembers().get(1).getName());
        ...
        Assert.assertEquals("N-A02", events.get(0).getLocations().get(0).getName());
        ...
        Assert.assertEquals("N-B12", events.get(0).getLocations().get(1).getName());
        ...
        Assert.assertEquals("Transport & Planning", events.get(1).getActivityDescription());
        Assert.assertEquals("TP", events.get(1).getModuleCode());
        ...
        Assert.assertEquals("Department of Engineering", events.get(1).getDepartment().getName());
        ...
        Assert.assertEquals("Ms. Walker (Wal)", events.get(1).getStaffMembers().get(0).getName());
        ...
        Assert.assertEquals("N-F31", events.get(1).getLocations().get(0).getName());
        ...
        Assert.assertEquals("Tag A", events.get(1).getTags().get(0).getName());
        Assert.assertEquals("TagB", events.get(1).getTags().get(1).getKey());
        Assert.assertEquals("Tag B", events.get(1).getTags().get(1).getName());
