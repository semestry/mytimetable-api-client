...
public class TimetableListStreamMapperTest extends BaseStreamMapperTest<TimetableListMapper> {
    ...
    public void testMapper() throws Exception {
        ...
        Assert.assertEquals("AE", timetables.get(0).getHostKey());
        Assert.assertEquals("2017!module!49CBD432F01E8C5057B344E02604A76F", timetables.get(0).getKey());

        Assert.assertEquals("BioRobotics", timetables.get(1).getDescription());
        Assert.assertEquals("BR", timetables.get(1).getHostKey());
        Assert.assertEquals("2017!module!49CBD432F01E8C5057B344E02604A770", timetables.get(1).getKey());
    }
}
