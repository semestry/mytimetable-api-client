 ...
 * @author Marco Krikke
 */
public class TimetableTypeDetailsListStreamMapper extends StreamMapper<List<TimetableType>> {

    public TimetableTypeDetailsListStreamMapper(ObjectMapper mapper) {
        super(mapper);
    }
